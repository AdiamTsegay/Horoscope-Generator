...
function horoscopeTime() {
  ...
  if (
    ...
    document.querySelector("#signDescription").innerText =
      "You're an air sign! You possess the following strengths: Progressive, original, independent, and humanitarian.";
    document.querySelector("#zodiacPic").src = "images/aquarius.png";
    ...
    document.querySelector("#signDescription").innerText =
      "You're a water sign! You possess the following strengths: Compassionate, artistic, intuitive, gentle, and wise.";
    document.querySelector("#zodiacPic").src = "images/pisces.png";
    document.querySelector(".results").style.backgroundColor = "black";
    ...
    document.querySelector("#zodiacSign").innerText =
      "You are an Aries, RAM RAM";
    document.querySelector("#signDescription").innerText =
      "You're a fire sign! You possess the following strengths: Courageous, determined, confident, and enthusiastic.";
    ...
    document.querySelector("#zodiacSign").innerText =
      "LOOK OUT FOR THE BULL, you're a Taurus like the creator...";
    document.querySelector("#signDescription").innerText =
      "You're an earth sign! You possess the following strengths: Reliable, patient, practical, devoted, and responsible.";
    ...
    document.querySelector("#zodiacSign").innerText =
      "Double Trouble, you're a Gemini!";
    document.querySelector("#signDescription").innerText =
      "You're an air sign! Your strengths are gentle, affectionate, curious, adaptable, ability to learn quickly and exchange ideas.";
    ...
    document.querySelector("#zodiacSign").innerText =
      "Look out, this Cancer ain't crabby!";
    document.querySelector("#signDescription").innerText =
      "You're a water sign! Your strengths are tenacious, highly imaginative, loyal, emotional, sympathetic, and persuasive.";
    ...
    document.querySelector("#signDescription").innerText =
      "You're a fire sign! Your strengths are creative, passionate, generous, warm-hearted, cheerful, and humorous.";
    ...
    document.querySelector("#signDescription").innerText =
      "You're an earth sign! Your strengths are loyal, analytical, kind, hardworking, and practical.";
    ...
    document.querySelector("#signDescription").innerText =
      "You're an air sign! Your strengths are cooperative, diplomatic, gracious, fair-minded, and social.";
    ...
    document.querySelector("#signDescription").innerText =
      "You're a water sign! Your strengths are resourceful, powerful, brave, passionate, and a true friend.";
    ...
    document.querySelector("#signDescription").innerText =
      "You're a fire sign! Your strengths are generous, idealistic, and a great sense of humor.";
    ...
    document.querySelector("#signDescription").innerText =
      "You're an earth sign! Your strengths are responsible, disciplined, self-control, and good managers.";
    document.querySelector("#zodiacPic").src = "images/capricorn.png";
    document.querySelector(".results").style.backgroundColor = "black";
    document.querySelector(".results").style.color = "#c23931";
  } else {
    document.querySelector("#zodiacSign").innerText = "invalid  entry";
    document.querySelector("#signDescription").innerText =
      "Hmm, something doesn't seem right...Try typing that again. Make sure to type your month (word) and day (number)";
    document.querySelector("#zodiacPic").src = "images/fish.png";
